  ...
  return (
    <div className="justify-start items-center gap-2 inline-flex">
      <div className="flex-col justify-start items-start inline-flex">
        {
          completed ?
            <div className={'w-[28px] h-[29px] relative bg-black rounded-lg justify-center items-center flex'}>
            ...
            >
              <div
                className={`text-[16px] font-medium text-center align-middle ${current ? 'text-white' : 'text-[#71717A]'}`}
              >
                {step}
              </div>
            </div>
